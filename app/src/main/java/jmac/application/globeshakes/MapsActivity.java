package jmac.application.globeshakes;
...
import jmac.application.globeshakes.Activities.QuakesListActivity;
import jmac.application.globeshakes.Model.EarthQuake;
import jmac.application.globeshakes.UI.CustomInfoWindow;
import jmac.application.globeshakes.Util.Constants;
    ...
    private void getQuakeDetails ( String url ) {
        ...
        JsonObjectRequest jsonObjectRequest = new JsonObjectRequest ( Request.Method.GET,
            ...
            public void onResponse ( JSONObject response ) {
                ...
                try {JSONObject properties = response.getJSONObject ( "properties" );
